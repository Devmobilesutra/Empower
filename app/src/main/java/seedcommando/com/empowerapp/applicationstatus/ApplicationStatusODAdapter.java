...
/**
 * Created by commando4 on 5/21/2018.
 */

public class ApplicationStatusODAdapter extends BaseAdapter {
    private Context mContext;
    private LayoutInflater mInflater;
    private ArrayList<WorkFromHomeSetDataPoJo> mDataSource;

    public ApplicationStatusODAdapter(Context context, ArrayList<WorkFromHomeSetDataPoJo> items) {
        mContext = context;
        mDataSource = items;
