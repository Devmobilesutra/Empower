package seedcommando.com.empowerapp.manageractivity;
...
import seedcommando.com.empowerapp.HomeFragment;
...
import seedcommando.com.empowerapp.Out_Duty_Application;
...
public class CalenderFragment extends Fragment {
  ...
  static Calendar currentDate = Calendar.getInstance();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        seedcommando.com.empowerapp.manageractivity.CalendarView cv = rootView.findViewById(R.id.calendar_view);
        cv.updateCalendar();
