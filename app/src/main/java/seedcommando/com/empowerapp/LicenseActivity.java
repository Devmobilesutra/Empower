...
public class LicenseActivity extends AppCompatActivity {
    ...
    private seedcommando.com.empowerapp.restforreg.ApiInterface apiService;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        apiService = seedcommando.com.empowerapp.restforreg.ApiClient.getClient().create(seedcommando.com.empowerapp.restforreg.ApiInterface.class);
