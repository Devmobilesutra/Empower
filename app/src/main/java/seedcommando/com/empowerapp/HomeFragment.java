...
import seedcommando.com.empowerapp.manageractivity.AttendanceSummaryFragment;
import seedcommando.com.empowerapp.manageractivity.CalenderFragment;
import seedcommando.com.empowerapp.manageractivity.SunordinateSummary;
import seedcommando.com.empowerapp.manageractivity.WeekReportPojo;
...
*/
    ...
    private void setUpNavigationView() {
        ...
        {
            menu.removeItem(7);
            MenuItem item = menu.add(R.id.group1, 7, 7, "LOGOUT");
            item.setIcon(R.drawable.ic_action_clock); // add icon with drawable resource
            //menu.add("SHIFT ALLOCATION").setIcon(R.drawable.ic_action_clock);
        }
        ...
        {
            menu.removeItem(6);
            MenuItem item = menu.add(R.id.group1, 6, 6, "CHANGE PASSWORD");
            item.setIcon(R.drawable.ic_action_clock); // add icon with drawable resource
            //menu.add("SHIFT ALLOCATION").setIcon(R.drawable.ic_action_clock);
        }
    }
